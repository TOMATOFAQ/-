...
//需要人为调参的量: 
#define ps 80//种群大小 population size
#define mit 700 //迭代次数 mount for iteratior
#define pc 0 //交配概率 probability for crossover
#define pm 0 //突变概率 probability for mutationi
// #define totalnum 100 //遗传算法的次数 //未限制时间之前的遗传次数,限制时间之后就不限制次数了,直接跑到规定时间为止
...
//用于多线程的两个全局变量
int final_result = ((unsigned)1<<31)-1; //存放最短时间
...
int main(){
	...
	Sleep(2900000);
	printf("The final_result is %d.",final_result);
